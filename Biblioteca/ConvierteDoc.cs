    ...
    public static class ConvierteDoc
    {
        public static Documento Convertir(DocumentoDTO dto)
        {
            return new Documento
            {
                ...
                TipoID = dto.TipoID,
                Tipo = ObtenerTextoPorID(dto.TipoID),
                UsuarioID = dto.UsuarioID,
                Usuario = ObtenerTextoPorID(dto.UsuarioID),
                ...
                Revisado = ObtenerTextoPorID(dto.RevisadoID),
        ...
        {
            // Método ficticio para obtener el texto correspondiente a un ID
